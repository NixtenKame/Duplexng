...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $time_zone = $_POST['time_zone'] ?? 'Eastern Time (US & Canada)';
    ...
    if ($name === '' || $password === '' || $password_confirm === '') {
        ...
        $stmt = $pdo->prepare("
            INSERT INTO public.users (
                ...
                level, base_upload_limit, comment_threshold,
                default_image_size, time_zone, per_page,
                bit_prefs, unread_dmail_count, profile_about, profile_artinfo
            ) VALUES (
        ...
        try {
            ...
            if (strpos($e->getMessage(), "index_users_on_name") !== false) {
                $error = "That username is already taken.";
            } elseif (strpos($e->getMessage(), "index_users_on_email") !== false) {
...
<head>
    ...
    <link rel="stylesheet" href="/packs/css/signup.css">
</head>
<body>
<nav>
  <div class="nav-logo">
...
<div class="container">
    ...
    <form method="post">
        ...
        <select class="time_zone optional" name="user[time_zone]" id="user_time_zone">
            ...
            <option value="Bad Dragon">(GMT-07:00) Bad Dragon</option>
